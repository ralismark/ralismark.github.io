...
![Photo of my split keyboard](/assets/nyquist.jpg)
My keyboard
...
![Regular keyboard, but with key-sized wooden blocks glued on top of the two control keys](/assets/palm-key.jpg)
...
![12 keys in a row, with a gap between the 6th and the 7th. In order, control, alt, layer, win, space, enter, shift, backspace, alt, down, up, control](/assets/keyboard-layout.png)
